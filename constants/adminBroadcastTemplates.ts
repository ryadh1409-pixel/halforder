...
export const ADMIN_BROADCAST_TEMPLATES: readonly AdminBroadcastTemplate[] = [
  {
    ...
    message: 'New food just dropped — open the app and find someone to share with.',
  },
  {
    label: '🍕 Someone is waiting near you',
    title: 'Someone is waiting near you',
    message: 'A HalfOrder match is live nearby — join before the slot fills up.',
  },
  {
    label: '💸 Invite friends and earn',
    title: 'Invite a friend',
    message: 'Share an order with a friend on HalfOrder and both earn bonus credits.',
  },
] as const;
