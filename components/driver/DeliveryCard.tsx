...
const styles = StyleSheet.create({
  ...
  orderId: { fontSize: 12, color: '#7D8493', fontWeight: '700' },
  live: { color: '#EF4444', fontWeight: '900', fontSize: 12 },
  restaurantRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10 },
  restaurantImage: { width: 50, height: 50, borderRadius: 12, marginRight: 10, backgroundColor: 'rgba(255,255,255,0.1)' },
  restaurantFallback: { alignItems: 'center', justifyContent: 'center' },
  restaurantFallbackText: { color: '#B7BDC9', fontWeight: '800' },
  restaurantMeta: { flex: 1 },
  restaurantName: { color: '#FFFFFF', fontWeight: '800', fontSize: 17 },
  subMeta: { marginTop: 2, color: '#7D8493', fontWeight: '600', fontSize: 13 },
  customerRow: { flexDirection: 'row', alignItems: 'center', marginTop: 12 },
  customerAvatar: { width: 38, height: 38, borderRadius: 999, marginRight: 10, backgroundColor: 'rgba(255,255,255,0.1)' },
  customerFallback: { alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(59,130,246,0.18)' },
  customerFallbackText: { color: '#1E3A8A', fontWeight: '800' },
  customerMeta: { flex: 1 },
  customerName: { color: '#FFFFFF', fontWeight: '800' },
  items: { marginTop: 12, color: '#B7BDC9', fontWeight: '600' },
  money: { marginTop: 5, color: '#B7BDC9', fontWeight: '600' },
  total: { marginTop: 6, color: '#FFFFFF', fontWeight: '800', fontSize: 15 },
  mapPlaceholder: {
    marginTop: 12,
    borderRadius: 12,
    borderWidth: 1,
