...
const styles = StyleSheet.create({
  ...
  sectionTitle: { flex: 1, color: '#FFFFFF', fontSize: 18, fontWeight: '800' },
  sectionCount: {
    color: '#7D8493',
    fontSize: 14,
    fontWeight: '700',
  ...
  chevron: { color: '#7D8493', fontSize: 16, fontWeight: '700' },
  list: { gap: 10 },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  restaurant: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' },
  meta: { color: '#7D8493', fontSize: 13 },
  time: { color: '#7D8493', fontSize: 12 },
  ...
  emptyTitle: { color: '#7D8493', fontSize: 15, fontWeight: '700' },
  emptySub: { color: '#7D8493', fontSize: 13, lineHeight: 18 },
});
