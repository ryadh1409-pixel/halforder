...
const styles = StyleSheet.create({
  ...
  customer: { fontSize: 17, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.2 },
  id: { marginTop: 4, color: '#7D8493', fontWeight: '700', fontSize: 12 },
  ...
  meta: { color: '#7D8493', fontWeight: '700', fontSize: 12 },
  bottom: {
    marginTop: 14,
    paddingTop: 12,
