...
const styles = StyleSheet.create({
  ...
  payoutLabel: { color: '#7D8493', fontWeight: '700', fontSize: 12 },
  payoutVal: { color: '#22C55E', fontWeight: '900', fontSize: 28, marginTop: 4 },
  ...
  card: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(125,132,147,0.16)',
  },
  cardTitle: { color: '#7D8493', fontWeight: '800', fontSize: 12, marginBottom: 6, marginTop: 10 },
  body: { color: '#B7BDC9', fontWeight: '600', fontSize: 15, lineHeight: 22 },
  muted: { color: 'rgba(148,163,184,0.85)', fontWeight: '600', marginTop: 8 },
  itemLine: { color: '#B7BDC9', fontWeight: '600', marginTop: 6 },
  ...
  waitingHint: { color: '#7D8493', fontWeight: '600', fontSize: 14, marginTop: 12, lineHeight: 20 },
});
