    ...
    await paymentRef.set(
      {
        ...
        originalServiceFeeCents: quote.originalServiceFeeCents,
        sharedServiceFeeCents: quote.sharedServiceFeeCents,
        originalDeliveryFeeCents: quote.originalDeliveryFeeCents,
        originalDeliveryFee: quote.originalDeliveryFeeCents / 100,
        sharedDeliveryFee: quote.deliveryShareCents / 100,
        originalServiceFee: quote.originalServiceFeeCents / 100,
        sharedServiceFee: quote.sharedServiceFeeCents / 100,
        deliverySaving: quote.deliverySavingCents / 100,
        serviceFeeSaving: quote.serviceFeeSavingCents / 100,
        promotionSaving: quote.promotionSavingCents / 100,
        foodSaving: quote.foodSavingCents / 100,
        totalSaving: quote.totalSavingCents / 100,
        freeDelivery: quote.freeDelivery,
        freeServiceFee: quote.freeServiceFee,
