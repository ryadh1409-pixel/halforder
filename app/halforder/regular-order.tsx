...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 4, marginBottom: 12, color: '#7D8493', fontWeight: '600' },
  activeCard: {
    borderRadius: 16,
    borderWidth: 1,
    borderColor: '#3B82F6',
  ...
  secondaryBtn: { borderWidth: 1, borderColor: '#3B82F6', backgroundColor: '#09090B' },
  ...
  mealName: { color: '#FFFFFF', fontSize: 18, fontWeight: '800' },
  meta: { marginTop: 6, color: '#B7BDC9', fontWeight: '600' },
  restaurant: { marginTop: 8, color: '#7D8493', fontSize: 12, fontWeight: '600' },
  orderBtn: {
    marginTop: 12,
    height: 48,
    borderRadius: 12,
