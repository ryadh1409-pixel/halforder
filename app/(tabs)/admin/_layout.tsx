  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="user/[id]" options={{ title: 'Customer' }} />
        ...
        <Stack.Screen
          name="complaints"
          options={{ title: 'Customer Complaints' }}
        />
        <Stack.Screen
          name="notifications"
        ...
        />
        <Stack.Screen name="push-center" options={{ title: 'Push Center' }} />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name="wallet-management/index"
          options={{ title: 'Wallet Management' }}
        />
        <Stack.Screen
          name="wallet-management/[ownerType]/[ownerId]"
          options={{ title: 'Partner Earnings Wallet' }}
        />
        <Stack.Screen
          name="wallet-management/customer/[userId]"
