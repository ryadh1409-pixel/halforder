...
const styles = StyleSheet.create({
  ...
  period: { color: '#64748b', fontWeight: '700', fontSize: 12 },
  title: { fontSize: 20, fontWeight: '900', color: '#0f172a', marginTop: 10 },
  ...
  body: { color: '#334155', fontSize: 13, lineHeight: 19, marginBottom: 4 },
  ...
  kpiLabel: { fontSize: 10, fontWeight: '800', color: '#64748b' },
  kpiValue: { fontSize: 15, fontWeight: '900', color: '#0f172a', marginTop: 2 },
  alert: {
    marginTop: 8,
  ...
  alertTitle: { color: '#b91c1c', fontWeight: '900', fontSize: 15 },
  alertSub: { color: '#7f1d1d', fontSize: 12, marginBottom: 8 },
  exception: {
    backgroundColor: '#fff',
    borderRadius: 10,
    padding: 10,
  ...
  exceptionTitle: { fontWeight: '800', color: '#0f172a' },
  mono: {
    fontFamily: 'Courier',
    fontSize: 10,
    color: '#475569',
