...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#7D8493', fontWeight: '600' },
  sectionTitle: { color: '#FFFFFF', fontSize: 20, fontWeight: '800', marginBottom: 10, marginTop: 8 },
  onlineRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  onlineLabel: { color: '#B7BDC9', fontWeight: '700' },
  card: {
    borderRadius: 16,
    borderWidth: 1,
  ...
  orderId: { color: '#FFFFFF', fontWeight: '800', fontSize: 18, marginBottom: 2 },
  meta: { color: '#B7BDC9', marginTop: 4, fontWeight: '600' },
  status: { color: '#1D4ED8', marginTop: 6, fontWeight: '800' },
  primaryButton: { marginTop: 10, height: 42, borderRadius: 10, backgroundColor: '#22C55E', alignItems: 'center', justifyContent: 'center' },
  primaryText: { color: '#FFFFFF', fontWeight: '800' },
  secondaryButton: { marginTop: 8, height: 40, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: '#09090B', alignItems: 'center', justifyContent: 'center' },
