...
describe('customer courier timeline progression', () => {
  it('maps ready_for_pickup to Waiting at restaurant', () => {
    const order = {
    ...
    expect(customerTrackHeaderTitle('waiting_at_restaurant')).toBe('Waiting at restaurant');
    expect(customerTrackStepLabel('waiting_at_restaurant')).toBe('Waiting at restaurant');
  });
